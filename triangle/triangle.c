...
{
    FILE *f1;
    f1 = fopen ("3angleout.tri", "wt");

  printf("\nStatistics:\n\n");
  printf("  Input vertices: %d\n", m->invertices);
/*
  fprintf(f1, "  Input vertices: %d\n", m->invertices);
*/
...
/*
  fprintf(f1, "  Mesh triangles: %ld\n", m->triangles.items);
*/

  printf("  Mesh edges: %ld\n", m->edges);
/*
  fprintf(f1, "  Mesh edges: %ld\n", m->edges);
*/
  fprintf(f1, "%ld", m->edges);

  printf("  Mesh exterior boundary edges: %ld\n", m->hullsize);
/*
  fprintf(f1, "  Mesh exterior boundary edges: %ld\n", m->hullsize);
*/
